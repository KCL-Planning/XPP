...
\joerg{0.5 pages. TBD if we need this. Given the ijcai feedback, I
  ...
  before; and discuss any other relations not discussed before due to
  text flow/or give more details on things that were mentioned. XAIP,
  OSP, conflict analysis, domain analysis, model checking.}
