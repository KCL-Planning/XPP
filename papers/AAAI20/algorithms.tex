\section{Computing Goal-Property Dependencies}
\label{algorithms}
...
\joerg{0.5--1 page: spell out ijcai version; emphasize novel aspects,
  ...
  illustration of bottom-up/top-down, but not complete ie no actual
  MUGS}

local alg: bottom-up start from A; top-down dont allow temove facts from Aq

mention specificity to particular plan here? ie only B true on plan?
how would algorithms change given this?
