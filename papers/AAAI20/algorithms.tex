...
function. 
%
Furthermore, we extended both conjunction and trap learning to deal
with OSP plan-cost bounds. \joerg{how did we do that? something
  interesting to say reg this?}
