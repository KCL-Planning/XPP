...
runtime (solid, left y-axis). Right: average \#MUGS.  \joerg{complete
this plot; ideally it should be BW-print readable, not sure if this is
possible. can we integrate the reference points as horizontal lines
into the left plot?}\rebecca{update plot with new benchmark results}}
\vspace{-0.6cm}
\end{figure}
...
Blocksworld (bottom right). Number of action-set properties on
x-axis scaling from 1 to 10.\joerg{complete this plot; ideally it should be BW-print
readable, not sure if this is possible. die stricher oben an den plots
(x-achse oben) sehen komisch aus, bitte weg. x-achsen bitte 1 5 10
beschriften. Bitte die legend unter diese plots, wie im IJCAI'19 long
paper unter Figure 2.}}
\vspace{-0.2cm}
\end{figure}
...
Blocksworld ???. \joerg{complete this plot; ideally it should be
BW-print readable, not sure if this is possible. can we integrate the
reference points as horizontal lines into the left plot?}\rebecca{choose between c125 top and c100 bottom}}
%
