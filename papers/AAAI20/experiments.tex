...
\rebecca{if we increase $|A|$ we are equal or better in 6 domains than lmcut 
and in 12 domains than osp}
...
unsolvable property sets. TODO: check fig 4 coverage of SysW
blocksworld at 1.5, curve is flat does not seem to match the data in
fig 3; add Rovers data everywhere}
...
%
%\joerg{integrate reference point coverage as horizontal lines into
%the left plot} ==> see fig 3: we never surpass that except lmcut in
%rovers and trap in blocks for c>1 when we dont use trap; so not much
%to show off
%
