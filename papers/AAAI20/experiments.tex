...
benchmarks, cost bound $0.75$, for SysS\joerg{with or without nogood
learning?} as a function of $|A|$. Left: coverage, \ie, fraction of
...
right.\joerg{include reference point data everywhere; include
reference points in plot legend}}
%
...
NoMystery red, Rovers orange, TPP green.\joerg{remove
coverage}\joerg{replace by b/w readable version?}}
%
\vspace{-0.6cm}
\end{figure}
