...
\joerg{Dan, I made a first go at this, basically starting from the
  related work section rom our AFOSR proposal, and extending that to
  reflect the current status a bit better. Please check, and revise as
  you see fit.}
