...
practice, is that between \defined{atomic} vs.\ \defined{composed}
...
\joerg{This definition is optional, depending on whether or not we
  decide to actually keep in the several different related definitions
  in the next section:}
...
the PDA for $\props^B$ is \defined{polynomially derivable} from that
