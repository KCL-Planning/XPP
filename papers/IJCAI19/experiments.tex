...
\joerg{number of MUGS = worst-case answer size! (pick one fact from each MUG)... 
describe and discuss as such in the text}
...
\michael{Say something more about the \# MUGS}
