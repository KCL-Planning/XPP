...
For lack of space, we only summarize our data (full plots are at
...
are moderately competitive with the reference points (\joerg{statement
where coverage for these starts to go down}). Trap learning is highly
