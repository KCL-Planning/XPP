...
\node[draw] (test) at (8,-12) {
\ref{plot:properties_hff_bu_21} properties-hff-bu
\ref{plot:properties_hff_td_21} properties-hff-td
\ref{plot:properties_trap_prefop_bu_21} properties-trap-prefop-bu
\ref{plot:properties_trap_prefop_td_21} properties-trap-prefop-td
};
