...
conjunctions.
%
%The question remains how to compute the dominant PDO-CE.
...
\defined{\hc\ transfer} in systematic weakening: the refined \hc\ from
...
\joerg{mention relation of minimum unsolvable goal subsets/of PDE-CE
