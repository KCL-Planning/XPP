...
\joerg{merge bottom-up computation in here. should be easy, make
  additional list or, better, brief text par below list explaining the
  dual bottom-up procedure.}
