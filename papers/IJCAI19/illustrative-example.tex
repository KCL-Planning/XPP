...
with fuel consumption. Figure~\ref{fig:nomystery-example} illustrates
an example task with two trucks and three packages. Fuel costs are
indicated at road segments (initial fuel is $16$ for $T_0$ and $7$ for
$T_1$). The packages are initially at $L_0$ (shown in blue); their
