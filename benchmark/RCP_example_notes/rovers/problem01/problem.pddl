(define (problem roverprob--s34--m25--r2--w4--o2--c1--g2--p1--P1--C10) (:domain Rover)
(:objects
	general - Lander
...
(:init
	...
	(energycost level22 waypoint0 waypoint1)
	(energycost level22 waypoint1 waypoint0)
	(energycost level10 waypoint0 waypoint2)
	(energycost level10 waypoint2 waypoint0)
	(energycost level24 waypoint0 waypoint3)
	(energycost level24 waypoint3 waypoint0)
	(energycost level6 waypoint1 waypoint2)
	(energycost level6 waypoint2 waypoint1)
	(energycost level23 waypoint1 waypoint3)
	(energycost level23 waypoint3 waypoint1)
	(energycost level15 waypoint2 waypoint3)
	(energycost level15 waypoint3 waypoint2)
